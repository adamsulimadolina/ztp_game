...
{
    class JungleLevelBuilder : IBoardBuilder
    {
        ...
        public JungleLevelBuilder(ContentManager content)
        {
        ...
        public void GenerateBlock()
        {
            ...
            block.SetType(Block.LevelType.Jungle);

            block._texture = content.Load<Texture2D>("JungleLevel/Block");
            block.Position.X = x;
            block.Position.Y = y;
        ...
        public void GenerateBorder()
        {
            ...
            border._texture = content.Load<Texture2D>("JungleLevel/Border");
            border.Position.X = x;
            border.Position.Y = y;
        ...
        {
            Coin coin = new Coin();
            coin._texture = content.Load<Texture2D>("JungleLevel/Point");
            coin.Position.X = x;
            coin.Position.Y = y;
        ...
        {
            Door doors = new Door();
            doors._texture = content.Load<Texture2D>("JungleLevel/Exit");
        ...
        public void GenerateLeftThorn()
        {
            ...
            thorn._texture = content.Load<Texture2D>("JungleLevel/TornLeft");
            thorn.Position.X = x;
            thorn.Position.Y = y;
        ...
        {
            Thorn thorn = new Thorn();
            thorn._texture = content.Load<Texture2D>("JungleLevel/TornRight");
            thorn.Position.X = x;
            thorn.Position.Y = y;
            sprite_collection.AddSprite(thorn);
        }
        ...
        public void GenerateBackground()
        {
            ...
            background._texture = content.Load<Texture2D>("JungleLevel/Background");
